  ...
  const handleSave = async (regionId: string) => {
    try {
      ...
      const response = await apiClient.put(
        `/api/admin/platform/region-labels/${regionId}`,
        {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Customize how region names appear to users on the homepage globe and
            throughout the platform. These labels are shown instead of the
            provider&apos;s native region names for whitelabeling.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TableBody>
                      ...
                      {editingId === label.region_id ? (
                        <Input
                          ...
                          onChange={(e) =>
                            setEditForm((prev) => ({
                              ...prev,
                              display_country: e.target.value,
                            }))
                          }
                ...
                {labels.length === 0 && (
                  <TableRow>
                    ...
                    >
                      No region labels found. Labels will be created when you
                      first edit them.
                    </TableCell>
                  </TableRow>
                )}
      ...
      <Card>
        ...
        <CardContent>
          <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
            <li>
              <strong>Display Name:</strong> The friendly name shown on the
              homepage globe and throughout the platform (e.g., &quot;US East
              (Newark)&quot; instead of &quot;Newark&quot;)
            </li>
            <li>
              <strong>Country:</strong> The country name displayed alongside the
              region
            </li>
            <li>
              <strong>Reset:</strong> Clicking the reset button removes the
              custom label and the platform will use the provider&apos;s native
              region name
            </li>
            <li>
              <strong>Globe Visualization:</strong> Changes take effect
              immediately on the homepage 3D globe
            </li>
          </ul>
        </CardContent>
      </Card>
