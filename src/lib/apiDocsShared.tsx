...
export const buildBaseSections = (apiBase: string): SectionDefinition[] => [
              ...
              apiKeys: [
                {
                  ...
                  lastUsedAt: "2026-10-25T08:30:00Z",
                },
              ],
            },
          },
              ...
              transactions: [
                {
                  ...
                  balanceAfter: 245.67,
                  createdAt: "2026-10-26T14:55:00Z",
                },
              ],
              ...
              payments: [
                {
                  ...
                  createdAt: "2026-10-26T14:54:00Z",
                  updatedAt: "2026-10-26T14:55:00Z",
                },
              ],
              pagination: { hasMore: false },
            },
      ...
      },
      {
        ...
        endpoints: [
          ...
          // NOTE: POST /credits/purchase/complete has been removed
          // Use POST /api/organizations/:id/egress/credits/purchase/complete instead
          {
            method: "GET",
          ...
          },
          {
            ...
            description: "Purchase egress credits using wallet balance instead of PayPal.",
            auth: true,
            body: {
              packId: "pack_1tb",
            },
            response: {
              ...
              transaction: {
                ...
                amount: 80,
                type: "debit",
                description: "Egress credit purchase: 1TB pack",
              },
            },
          },
          {
            ...
            response: {
              readings: [
                {
                  vpsId: "vps_001",
                  timestamp: "2026-10-26T14:00:00Z",
          ...
          },
          {
            ...
            response: {
              summary: {
                ...
                periodEnd: "2026-10-26T23:59:59Z",
              },
            },
          },
        ],
              ...
              activities: [
                {
                  ...
                  status: "success",
                  timestamp: "2026-10-25T08:00:00Z",
                },
              ],
              ...
              activities: [
                {
                  ...
                  status: "success",
                  timestamp: "2026-10-26T14:55:00Z",
                },
              ],
            },
          },
              ...
              tickets: [
                {
                  ...
                  updated_at: "2026-10-24T12:00:00Z",
          ...
          },
          {
            ...
            response: {
              reply: {
                ...
                ticket_id: "ticket_001",
                message: "Thanks! Issue resolved after reboot.",
                created_at: "2026-10-24T12:30:00Z",
              },
            },
          },
          {
              ...
              notifications: [
                {
                  ...
                  is_read: false,
                  created_at: "2026-10-26T14:55:00Z",
                },
              ],
              pagination: { hasMore: false },
            },
      ...
      },
      {
        ...
        endpoints: [
          ...
          },
          {
            ...
            response: {
              reply: {
                ...
                created_at: "2026-10-24T11:30:00Z",
              },
            },
          },
          {
          ...
          },
          {
            ...
            response: {
              availability: {
                ...
                updatedAt: "2026-10-25T10:00:00Z",
              },
            },
          },
          {
          ...
          },
          {
            ...
            response: {
              regionLabels: [
                ...
                { regionId: "eu-west", label: "EU West (Frankfurt)", displayOrder: 2 },
              ],
            },
          },
          {
          ...
          },
          {
            method: "PUT",
            path: "/platform/region-labels/:regionId",
            description: "Update the display label for a specific region.",
            auth: true,
            body: { label: "US East Coast", displayOrder: 1 },
            response: {
              success: true,
              regionLabel: {
                regionId: "us-east",
          ...
          {
            method: "POST",
            path: "/platform/region-labels/bulk",
            description: "Bulk create or update region labels.",
            auth: true,
            body: {
              labels: [
                { regionId: "us-east", label: "US East", displayOrder: 1 },
                { regionId: "us-west", label: "US West", displayOrder: 2 },
              ],
            },
            response: {
              success: true,
          ...
          },
          {
            ...
            auth: true,
            body: { name: "API Reference", slug: "api-reference", displayOrder: 2 },
            response: {
              success: true,
              category: { id: "cat_002", name: "API Reference", slug: "api-reference" },
            },
          },
          // NOTE: GET /documentation/categories/:id does not exist
          // Use GET /documentation/categories and filter by ID client-side
          {
            method: "PUT",
            path: "/documentation/categories/:id",
            description: "Update a documentation category.",
            auth: true,
            body: { name: "Updated Name", displayOrder: 3 },
            response: {
              success: true,
              category: { id: "cat_001", name: "Updated Name" },
            },
          },
          {
            method: "DELETE",
          ...
          {
            method: "POST",
            path: "/documentation/categories/reorder",
            description: "Reorder documentation categories.",
            auth: true,
            body: { order: ["cat_002", "cat_001"] },
            response: { success: true, message: "Categories reordered" },
          },
          {
            method: "GET",
          ...
          },
          {
            ...
            auth: true,
            body: { title: "New Article", slug: "new-article", content: "Article content", categoryId: "cat_001" },
            response: {
              success: true,
              article: { id: "art_002", title: "New Article", slug: "new-article" },
            },
          },
          {
            method: "GET",
          ...
          },
          {
            method: "PUT",
            path: "/documentation/articles/:id",
            description: "Update a documentation article.",
            auth: true,
            body: { title: "Updated Title", content: "Updated content" },
            response: {
              success: true,
              article: { id: "art_001", title: "Updated Title" },
            },
          },
          {
            method: "DELETE",
          ...
          {
            method: "POST",
            path: "/documentation/articles/reorder",
            description: "Reorder documentation articles within a category.",
            auth: true,
            body: { categoryId: "cat_001", order: ["art_002", "art_001"] },
            response: { success: true, message: "Articles reordered" },
          },
          {
            method: "POST",
            path: "/documentation/articles/:id/files",
            description: "Upload a file attachment to an article.",
            auth: true,
            body: { file: "<binary>" },
            response: {
              success: true,
              file: { id: "file_001", filename: "screenshot.png", articleId: "art_001" },
            },
          },
          {
            method: "DELETE",
          ...
          },
          {
            method: "POST",
            path: "/ssh-keys",
            description: "Create an SSH key for an organization (admin override).",
            auth: true,
            body: { name: "Admin Key", publicKey: "ssh-ed25519 AAAA...", organizationId: "org_001" },
            response: {
              success: true,
              sshKey: { id: "ssh_002", name: "Admin Key" },
            },
          },
          {
            method: "DELETE",
          ...
          },
          {
            ...
            response: {
              ...
              member: {
                ...
                organization_id: "org_001",
                role_id: "role_member",
                joined_at: "2026-10-25T10:00:00Z",
              },
            },
          },
          {
          ...
          },
          {
            ...
            params: { limit: 50 },
            response: {
              history: [{ id: "egress_001", amount: 100, chargedAt: "2026-10-26T10:00:00Z" }],
            },
          },
        ],
      },
      ...
      {
        title: "Documentation",
        base: `${apiBase}/documentation`,
        description: "Public documentation articles and categories.",
          ...
          },
          {
            ...
            response: {
              category: {
                ...
                articles: [{ id: "art_001", title: "Quick Start", slug: "quick-start" }],
              },
            },
          },
          {
            ...
            response: {
              article: {
                ...
                files: [{ id: "file_001", filename: "screenshot.png" }],
              },
            },
          },
          {
