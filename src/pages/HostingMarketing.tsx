...
const normalizePrice = (amount: number | string | null | undefined): number => {
...
const useHostingCatalog = (): HostingCatalogState => {
...
const HostingCatalogSection = ({ enabled, plans }: Pick<HostingCatalogState, "enabled" | "plans">) => (
