          ...
          <div className="rounded-lg border bg-card p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="md:col-span-2">
                <Label className="text-sm font-medium text-muted-foreground">User ID (UUID)</Label>
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-sm font-mono bg-muted px-2 py-1 rounded">{user?.id || 'Not provided'}</p>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-7 px-2"
