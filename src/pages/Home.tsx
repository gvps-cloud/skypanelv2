...
const getBaseUrl = () => {
  const rawClientUrl = (
    ...
    (import.meta.env as Record<string, string | undefined>).CLIENT_URL ||
    ""
  ).trim();
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left gpu-accelerated">
            ...
            >
              Deploy VPS instances and applications in seconds with unified
  ...
  const features = [
    {
      ...
      description:
        "Deploy VPS instances and applications in under 45 seconds with our streamlined provisioning system.",
    ...
    },
    {
      ...
      description:
        "Single interface for managing VPS, billing, and monitoring across all providers.",
      color: "from-primary to-primary/80",
    },
    {
      icon: BarChart3,
      ...
      description:
        "Live metrics, alerts, and performance tracking with customizable dashboards.",
      color: "from-primary to-primary/80",
    },
    {
      icon: Terminal,
      title: "Web-based SSH",
      description:
        "Secure terminal access directly through your browser with full SSH capabilities.",
      color: "from-primary to-primary/80",
    },
    {
      icon: Wallet,
      ...
      description:
        "Pay-as-you-go pricing with prepaid wallet system and transparent hourly rates.",
      color: "from-primary to-primary/80",
    },
    {
      icon: Wifi,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            From deployment to monitoring, we've built a comprehensive platform
            that handles the complexity so you can focus on your applications.
          </p>
        </motion.div>
        ...
        >
          <div className="inline-flex items-center gap-4 px-6 py-3 bg-muted/50 rounded-full border border-border/50">
            ...
            <span className="text-sm text-muted-foreground">
              Plus enterprise-grade security and 24/7 support
            </span>
          </div>
        </motion.div>
      </div>
...
const LiveShowcase = () => {
  ...
  const showcaseTabs = [
    ...
    },
    {
      ...
      icon: Server,
      description:
        "Deploy and manage virtual servers across multiple providers",
      features: [
    ...
    <section id="capabilities" className="py-24 bg-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See our platform in action with real interfaces and live
            functionality
          </p>
        </motion.div>
              ...
              <div className="bg-background rounded-2xl shadow-2xl border border-border overflow-hidden">
                ...
                <div className="relative bg-gradient-to-br from-card to-muted p-8 min-h-[400px]">
                  ...
                  <div className="absolute bottom-4 left-4 bg-background/90 backdrop-blur-sm px-3 py-1 rounded border border-border/50">
                    <span className="text-xs text-muted-foreground">
                      Click to explore full interface
                    </span>
                  </div>
                </div>
              </div>
  ...
  const useCases = [
    {
      ...
      description:
        "Rapid deployment environments with instant access to development servers and testing infrastructure.",
      benefits: [
        "Deploy dev environments in seconds",
    ...
    },
    {
      ...
      description:
        "Complete infrastructure management with monitoring, scaling, and automation capabilities.",
      benefits: [
    ...
    },
    {
      ...
      title: "For Startups",
      description:
        "Cost-effective scaling with pay-as-you-go pricing and enterprise-grade features.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "White-label solutions with custom branding, advanced security, and dedicated support.",
      benefits: [
    ...
    <section id="solutions" className="py-24 bg-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Whether you're a solo developer or running an enterprise, our
  ...
  const steps = [
    {
      ...
      description:
        "Create your account in minutes and add funds to your wallet using PayPal or other payment methods.",
      icon: UserCheck,
    },
    {
      number: "02",
      ...
      description:
        "Select from VPS instances or your curated StackScripts. Configure resources and regions.",
      icon: Package,
    },
    {
      number: "03",
      ...
      description:
        "Launch your infrastructure in under 45 seconds with automated setup and configuration.",
      icon: Rocket,
    },
    {
      number: "04",
      ...
      description:
        "Track performance, manage resources, and scale your infrastructure through our unified dashboard.",
      icon: BarChart3,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "VPS instances typically deploy in 45-60 seconds. StackScript-based installs finish in the same window because we pre-validate configurations to ensure smooth deployment every time.",
    },
    {
      question: "Which payment methods are supported?",
      answer:
        "We support PayPal-backed cards and are currently beta-testing ACH transfers. Every wallet top-up synchronizes instantly and triggers webhook events for automated workflows.",
    },
    {
      question: "Can I manage everything from one dashboard?",
      answer:
        "Yes! Our unified dashboard allows you to create, resize, backup, rebuild, and delete VPS instances, deploy applications, monitor performance, and manage billing - all from one interface.",
    },
    {
      question: "Is there a free tier for testing?",
      answer:
        "The platform itself is free to use - you only pay for the actual cloud provider resources you consume. We offer detailed monitoring and free tier management so you can build without friction.",
    },
    {
      question: "How does the billing system work?",
      answer:
        "We use a prepaid wallet system with hourly billing. Add funds to your wallet via PayPal, and we'll deduct costs hourly based on your actual resource usage. You can view detailed usage reports and set spending alerts.",
    },
  ];
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      >
        ...
        <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
          Your first deployment takes minutes. Add funds to your wallet and
          start deploying VPS instances and applications immediately.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            size="lg"
            className="bg-background text-primary hover:bg-background/90 px-8 py-4 text-lg rounded-xl"
            asChild
          >
            <Link to="/register">
              <Rocket className="w-5 h-5 mr-2" />
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-primary-foreground/20 bg-primary-foreground/10 text-primary-foreground hover:bg-primary-foreground/20 px-8 py-4 text-lg rounded-xl backdrop-blur-sm"
            asChild
          >
            <Link to="/contact">
